...
INSERT INTO `patient_scheduled_task` VALUES (1,'2023-07-13 10:00:00','2023-07-13 12:00:00',1,NULL,1),(2,'2023-07-13 10:00:00','2023-07-13 10:00:00',6,NULL,1),(3,'2023-07-14 10:00:00','2023-07-14 11:00:00',6,205,1),(4,'2023-07-14 10:00:00','2023-07-14 13:00:00',6,NULL,1),(5,'2023-07-15 10:00:00','2023-07-15 13:00:00',6,204,1),(6,'2023-07-16 10:00:00','2023-07-16 13:00:00',6,NULL,1),(7,'2023-07-17 10:00:00','2023-07-17 13:00:00',2,NULL,1),(8,'2023-07-17 10:00:00','2023-07-17 22:00:00',6,NULL,1),(9,'2023-07-15 10:00:00','2023-07-15 13:00:00',7,NULL,1),(10,'2023-07-15 17:00:00','2023-07-15 18:00:00',2,203,1),(11,'2023-07-13 10:00:00','2023-07-13 12:00:00',3,NULL,1),(12,'2023-07-14 10:00:00','2023-07-14 11:00:00',3,NULL,1),(13,'2023-07-12 10:00:00','2023-07-12 13:00:00',3,NULL,1),(14,'2023-07-12 10:00:00','2023-07-12 13:00:00',3,NULL,1),(17,'2023-07-09 10:00:00','2023-07-09 21:00:00',3,NULL,1),(18,'2023-07-11 10:00:00','2023-07-11 21:00:00',7,NULL,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=182 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=262 DEFAULT CHARSET=latin1 COLLATE=latin1_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `task_attribute` VALUES (1,'URL'),(2,'ImageUri');
...
INSERT INTO `task_attribute_value` VALUES (1,6,1,'https://instagram.es'),(2,4,2,'https://publicinterestnetwork.org/wp-content/uploads/2022/07/landscape-tree-nature-grass-horizon-mountain-1215802-pxhere.com_-1000x664.jpg'),(3,4,1,'https://instagram.es'),(4,8,2,'https://img.freepik.com/free-photo/book-composition-with-open-book_23-2147690555.jpg'),(5,9,2,'https://publicinterestnetwork.org/wp-content/uploads/2022/07/landscape-tree-nature-grass-horizon-mountain-1215802-pxhere.com_-1000x664.jpg');
...
INSERT INTO `task_i18n` VALUES (1,1,'Haz este ejercicio','Camina 5km a buen ritmo. Tú puedes!',2,NULL),(2,1,'Toma el desayuno','Es la hora del desayuno. Toma tu ración de cereales y de fruta para empezar el día con energía',3,NULL),(3,1,'Sube un comentario a tu red social preferida','Comparte con tus amig@s una foto de un lugar por donde te guste pasear',4,NULL),(4,1,'Practica esta técnica de relajación: Yoga','Vamos a tratar ayudarte a relajarte, a través de la práctica de yoga.  A continuación te explicamos paso a paso como empezar con ello',5,NULL),(5,1,'Toma tu medicación','Es la hora de tomar tu medicación, asegúrate que sigues la pauta que te ha recomendado tú médico',6,NULL),(6,1,'Responde al cuestionario','A continuación te vamos a solicitar que respondas a un conjunto de preguntas, para que podamos conocer mejor cómo te encuentras',7,NULL),(7,1,'Responde al cuestionario','A continuación te vamos a solicitar que respondas a un conjunto de preguntas, para que podamos conocer mejor cómo te encuentras',1,NULL),(8,1,'Empieza a leer un libro','Busca un libro de un genero que te interese y trata de leer el primer capítulo',8,NULL),(9,1,'Sal a dar un paseo','Es hora de disfritur de la naturaleza',9,'<p>¡Es hora de salir a pasear y disfrutar de la maravillosa naturaleza! Imagina un escenario lleno de <span class=\"highlight\">árboles majestuosos</span>, coloridas flores y el canto melodioso de los pájaros. Respira profundamente y siente cómo el aire fresco y puro acaricia tu rostro.</p><p>Caminar por senderos serpenteantes te permitirá <span class=\"highlight\">conectar</span> con la tranquilidad que solo la naturaleza puede brindar. Observa cómo la luz del sol se filtra entre las ramas, creando <span class=\"highlight\">juegos de sombras</span> que danzan a tu alrededor.</p><br/><br/><p>A medida que avanzas, sentirás la energía de la tierra bajo tus pies, mientras escuchas el suave crujir de las hojas secas que invitan a ser pisadas. Cada paso te acerca más a una aventura llena de <span class=\"highlight\">sorpresas naturales</span>.</p><br/><br/><p>No olvides detenerte y contemplar los pequeños detalles: una <span class=\"highlight\">mariposa colorida</span> revoloteando cerca, una ardilla curiosa saltando de rama en rama o un arroyo cristalino que refresca el ambiente. Estos encuentros inesperados te llenarán de asombro y alegría.</p>');
...
INSERT INTO `task_questionnaire` VALUES (1,1,1),(2,7,2),(3,9,2);
...
-- Dump completed on 2023-07-15 17:41:40
